...
**Artifact Rebuild Status:** not_needed

**LLM Runtime:** MOCK

## Release Candidate Verification (2026-05-26)

- Evidence source commit (at generation time): `d0d4d68`
- CI (main push) status: success — run `26439104797`
  - https://github.com/zparvez2z/uamas/actions/runs/26439104797
- Live Smoke status: success — run `26438819691`
  - https://github.com/zparvez2z/uamas/actions/runs/26438819691
...
- Created At (UTC): 2026-05-26T07:59:27.349395+00:00
...
```json
{
  ...
  "classifier_artifact_rejection_reason": null,
  "classifier_artifact_rebuild_attempted": false,
  "classifier_artifact_rebuild_status": "not_needed",
  ...
  "classifier_artifact_metadata": {
    ...
    "created_at_utc": "2026-05-26T07:59:27.349395+00:00",
